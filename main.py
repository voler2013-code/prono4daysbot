...
WEATHER_MODELS = {
    ...
    'ecmwf_ifs025': 'https://api.open-meteo.com/v1/forecast?latitude={lat}&longitude={lon}&hourly=temperature_2m,relative_humidity_2m,cloud_cover,wind_speed_10m,wind_direction_10m,temperature_850hPa,relative_humidity_850hPa,wind_speed_850hPa,wind_direction_850hPa&models=ecmwf_ifs025&timezone=America%2FSao_Paulo&forecast_days=7&format=json',
